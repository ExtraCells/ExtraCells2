...
public class ModelBusFluidStorage extends ModelBase
{
	...
	public ModelBusFluidStorage()
	  {
	    ...
	    textureHeight = 64;
	      ...
	      Shape4.setRotationPoint(-6F, 19F, -6F);
	      ...
	      Shape8.addBox(0F, 0F, 0F, 1, 3, 15);
	      Shape8.setRotationPoint(6.8F, 20.2F, -7.5F);
	...
	{
		FMLClientHandler.instance().getClient().func_110434_K().func_110577_a(new ResourceLocation("extracells", "textures/blocks/texmap_storage_bus.png"));
		GL11.glPushMatrix();
