...
public abstract class ECPacket
{
	...
	static
	{
		ImmutableBiMap.Builder<Integer, Class<? extends ECPacket>> builder = ImmutableBiMap.builder();
	...
	public final Packet makePacket() throws IllegalArgumentException
	{
		if (PacketHandler.CHANNEL_NAME != null)
		{
			...
			write(out);
			return PacketDispatcher.getPacket(PacketHandler.CHANNEL_NAME, out.toByteArray());
		}
		throw new IllegalArgumentException("You have to define a channel for the MMOMats packets first!");
	}
