...
public class ButtonRedstoneSwitch extends GuiButton
{
	public static RedstoneModeInput redstoneMode;

	public ButtonRedstoneSwitch(int ID, int xPos, int yPos, int width, int heigth, RedstoneModeInput mode)
	{
