...
Before we begin,
	...
	the changes to a minium and try to prevent breaking changes, however it will
...
Network Enumeration
	...
	tile is added / removed respecfully, if you fail to do this correctly, your tile,
	may ghost in the network, or cause invalid behavior. You must inform AE that your
...
Blocks / Items / Materials
	AE Exposes its Original Itemstacks via the Blocks, Items, Materials classes for easy access,
