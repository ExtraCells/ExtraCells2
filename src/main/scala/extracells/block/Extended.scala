...
trait Extended /*extends Block*/ {
  ...
  protected def createProperties(listed: mutable.ArrayBuffer[IProperty[_ <: Comparable[_]]], unlisted: mutable.ArrayBuffer[IUnlistedProperty[_]]): Unit = {}
  ...
  private def propertySize(property: IProperty[_ <: Comparable[_]]) = {
