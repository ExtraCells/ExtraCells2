                ...
                if (player.isSneaking() && current != null) {
                    try {
                        if (current.getItem() instanceof IToolWrench
                                && ((IToolWrench) current.getItem()).canWrench(player, x, y, z)) {
                            ItemStack block = new ItemStack(this, 1, world.getBlockMetadata(x, y, z));
                            if (tile != null && tile instanceof TileEntityFluidInterface) {
                                block.setTagCompound(
                                        ((TileEntityFluidInterface) tile).writeFilter(new NBTTagCompound()));
                            }
        ...
        switch (world.getBlockMetadata(x, y, z)) {
            ...
            case 1:
                ...
                if (tile != null) {
                    ...
                    if (tile instanceof IListenerTile) ((IListenerTile) tile).registerListener();
                }
                return;
            default:
                return;
        ...
        switch (meta) {
            ...
            case 1:
                ...
                if (tile != null) {
                    ...
                    if (tile instanceof IListenerTile) ((IListenerTile) tile).removeListener();
                }
                return;
            default:
                return;
