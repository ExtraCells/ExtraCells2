...
public class PartDriveModel implements IModel {
	...
	private static final Map<DriveSlotState, ResourceLocation> MODELS_CELLS = ImmutableMap.of(
		DriveSlotState.EMPTY, new ResourceLocation("extracells:part/drive_cell_empty"),
		DriveSlotState.OFFLINE, new ResourceLocation("extracells:part/drive_cell_off"),
		DriveSlotState.ONLINE, new ResourceLocation("extracells:part/drive_cell_on"),
		DriveSlotState.TYPES_FULL, new ResourceLocation("extracells:part/drive_cell_types_full"),
		DriveSlotState.FULL, new ResourceLocation("extracells:part/drive_cell_full")
	);
