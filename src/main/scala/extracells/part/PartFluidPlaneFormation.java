...
public class PartFluidPlaneFormation extends PartECBase implements IFluidSlotPartOrBlock, IGridTickable {
    ...
    public void doWork() {
        ...
        if (this.fluid == null || hostTile == null || gridBlock == null || this.fluid.getBlock() == null) return;
        ...
        IAEFluidStack canDrain = monitor.extractItems(
                FluidUtil.createAEFluidStack(this.fluid, FluidContainerRegistry.BUCKET_VOLUME),
                Actionable.SIMULATE,
                new MachineSource(this));
        if (canDrain == null || canDrain.getStackSize() < FluidContainerRegistry.BUCKET_VOLUME) return;
    ...
    public void renderStatic(int x, int y, int z, IPartRenderHelper rh, RenderBlocks renderer) {
        ...
        if (host != null) {
            ...
            if (isActive()) ts.setBrightness(13 << 20 | 13 << 4);
