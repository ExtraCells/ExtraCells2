...
public class PartBattery extends PartECBase implements IAEPowerStorage, IInventoryUpdateReceiver {
    ...
    public AccessRestriction getPowerFlow() {
        if (this.handler == null || this.battery == null) return AccessRestriction.NO_ACCESS;
    ...
    public double injectAEPower(double amt, Actionable mode) {
        if (this.handler == null || this.battery == null) return 0;
        return this.handler.injectAEPower(mode == Actionable.MODULATE ? this.battery : this.battery.copy(), amt);
    }
    ...
    public void onInventoryChanged() {
        ...
        if (this.battery != null && this.battery.getItem() instanceof IAEItemPowerStorage) {
