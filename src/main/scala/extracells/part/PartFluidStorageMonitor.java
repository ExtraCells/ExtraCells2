...
public class PartFluidStorageMonitor extends PartECBase implements IStackWatcherHost, INetworkToolAgent {
    ...
    public List<String> getWailaBodey(NBTTagCompound data, List<String> list) {
        ...
        else list.add(StatCollector.translateToLocal("waila.appliedenergistics2.Unlocked"));
    ...
    public NBTTagCompound getWailaTag(NBTTagCompound tag) {
        ...
        if (this.fluid == null) tag.setInteger("fluid", -1);
        else tag.setInteger("fluid", this.fluid.getID());
        return tag;
    }
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        if (data.hasKey("amount")) this.amount = data.getLong("amount");
        if (data.hasKey("fluid")) {
            int id = data.getInteger("fluid");
            if (id == -1) this.fluid = null;
            else this.fluid = FluidRegistry.getFluid(id);
        }
        if (data.hasKey("locked")) this.locked = data.getBoolean("locked");
    }
    ...
    public void renderDynamic(double x, double y, double z, IPartRenderHelper rh, RenderBlocks renderer) {
        ...
        if (this.dspList == null) this.dspList = GLAllocation.generateDisplayLists(1);
    ...
    private void renderFluid(Tessellator tess, IAEFluidStack fluidStack) {
        ...
        if (qty > 1000000000) msg = Long.toString(qty / 1000000000) + "MB";
        else if (qty > 1000000) msg = Long.toString(qty / 1000000) + "KB";
        else if (qty > 9999) msg = Long.toString(qty / 1000) + 'B';
    ...
    public void updateWatcher(IStackWatcher w) {
        this.watcher = w;
        if (this.fluid != null) w.add(FluidUtil.createAEFluidStack(this.fluid));
    ...
    public void writeToNBT(NBTTagCompound data) {
        ...
        if (this.fluid == null) data.setInteger("fluid", -1);
        else data.setInteger("fluid", this.fluid.getID());
    ...
    public void writeToStream(ByteBuf data) throws IOException {
        ...
        if (this.fluid == null) data.writeInt(-1);
        else data.writeInt(this.fluid.getID());
