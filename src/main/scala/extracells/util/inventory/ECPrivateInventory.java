...
public class ECPrivateInventory implements IInventory {
    ...
    public ItemStack decrStackSize(int slotId, int amount) {
        if (this.slots[slotId] == null) return null;
        ItemStack itemstack;
    ...
    public ItemStack incrStackSize(int slotId, int amount) {
        ...
        if (stackLimit > slot.getMaxStackSize()) stackLimit = slot.getMaxStackSize();
    ...
    public void markDirty() {
        if (this.receiver != null) this.receiver.onInventoryChanged();
    }
