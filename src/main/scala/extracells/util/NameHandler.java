...
public class NameHandler implements ISubItemResolver {
	...
	public Object resolveItemByName(String namespace, String fullName) {
		...
		if (fullName.equals("fluidCell1k"))
			return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(),
					0);
		...
		if (fullName.equals("physCell256k"))
			return new ResolverResult(
					ItemEnum.PHYSICALSTORAGE.getInternalName(), 0);
		if (fullName.equals("physCell1024k"))
			return new ResolverResult(
					ItemEnum.PHYSICALSTORAGE.getInternalName(), 1);
		if (fullName.equals("physCell4096k"))
			return new ResolverResult(
					ItemEnum.PHYSICALSTORAGE.getInternalName(), 2);
		if (fullName.equals("physCell16384k"))
			return new ResolverResult(
					ItemEnum.PHYSICALSTORAGE.getInternalName(), 3);
		if (fullName.equals("physCellContainer"))
			return new ResolverResult(
					ItemEnum.PHYSICALSTORAGE.getInternalName(), 4);

		// Fluid Storage Components
		if (fullName.equals("cell1kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 4);
		if (fullName.equals("cell4kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 5);
		if (fullName.equals("cell16kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 6);
		if (fullName.equals("cell64kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 7);
		if (fullName.equals("cell256kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 8);
		if (fullName.equals("cell1024kPartFluid"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 9);
		...
		if (fullName.equals("cell256kPart"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 0);
		if (fullName.equals("cell1024kPart"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 1);
		if (fullName.equals("cell4096kPart"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 2);
		if (fullName.equals("cell16384kPart"))
			return new ResolverResult(
					ItemEnum.STORAGECOMPONET.getInternalName(), 3);
		...
		if (fullName.equals("fluidPattern"))
			return new ResolverResult(ItemEnum.FLUIDPATTERN.getInternalName(),
					0);
		if (fullName.equals("fluidCrafter"))
			return new ResolverResult(BlockEnum.FLUIDCRAFTER.getInternalName(),
					0);
		if (fullName.equals("wirelessFluidTerminal"))
			return new ResolverResult(
					ItemEnum.FLUIDWIRELESSTERMINAL.getInternalName(), 0);
		if (fullName.equals("walrus"))
			return new ResolverResult(BlockEnum.WALRUS.getInternalName(), 0);
		if (fullName.equals("interface"))
			return new ResolverResult(BlockEnum.ECBASEBLOCK.getInternalName(),
					0);
