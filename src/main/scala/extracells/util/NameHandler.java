...
public class NameHandler implements ISubItemResolver {
    ...
    public Object resolveItemByName(String namespace, String fullName) {
        if (!namespace.equals("extracells")) return null;

        // Fluid Cells
        if (fullName.equals("fluidCell1k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 0);
        if (fullName.equals("fluidCell4k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 1);
        if (fullName.equals("fluidCell16k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 2);
        if (fullName.equals("fluidCell64k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 3);
        if (fullName.equals("fluidCell256k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 4);
        if (fullName.equals("fluidCell1024k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 5);
        if (fullName.equals("fluidCell4096k")) return new ResolverResult(ItemEnum.FLUIDSTORAGE.getInternalName(), 6);
        if (fullName.equals("fluidCellPortable"))
            return new ResolverResult(ItemEnum.FLUIDSTORAGEPORTABLE.getInternalName(), 0);

        // Gas Cells
        if (fullName.equals("gasCell1k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 0);
        if (fullName.equals("gasCell4k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 1);
        if (fullName.equals("gasCell16k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 2);
        if (fullName.equals("gasCell64k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 3);
        if (fullName.equals("gasCell256k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 4);
        if (fullName.equals("gasCell1024k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 5);
        if (fullName.equals("gasCell4096k")) return new ResolverResult(ItemEnum.GASSTORAGE.getInternalName(), 6);
        if (fullName.equals("gasCellPortable"))
            return new ResolverResult(ItemEnum.GASSTORAGEPORTABLE.getInternalName(), 0);

        // Physical Cells
        if (fullName.equals("physCell256k")) return new ResolverResult(ItemEnum.PHYSICALSTORAGE.getInternalName(), 0);
        if (fullName.equals("physCell1024k")) return new ResolverResult(ItemEnum.PHYSICALSTORAGE.getInternalName(), 1);
        if (fullName.equals("physCell4096k")) return new ResolverResult(ItemEnum.PHYSICALSTORAGE.getInternalName(), 2);
        if (fullName.equals("physCell16384k")) return new ResolverResult(ItemEnum.PHYSICALSTORAGE.getInternalName(), 3);
        if (fullName.equals("physCellContainer"))
            return new ResolverResult(ItemEnum.PHYSICALSTORAGE.getInternalName(), 4);
        if (fullName.equals("physCellAdvancedSingularity"))
        ...
        if (fullName.equals("cell256kPart")) return new ResolverResult(ItemEnum.STORAGECOMPONENT.getInternalName(), 0);
        if (fullName.equals("cell1024kPart")) return new ResolverResult(ItemEnum.STORAGECOMPONENT.getInternalName(), 1);
        if (fullName.equals("cell4096kPart")) return new ResolverResult(ItemEnum.STORAGECOMPONENT.getInternalName(), 2);
        ...
        if (fullName.equals("physCasing")) return new ResolverResult(ItemEnum.STORAGECASING.getInternalName(), 0);

        // Fluid Storage Casing
        if (fullName.equals("fluidCasing")) return new ResolverResult(ItemEnum.STORAGECASING.getInternalName(), 1);

        // Fluid Storage Casing
        if (fullName.equals("gasCasing")) return new ResolverResult(ItemEnum.STORAGECASING.getInternalName(), 2);
        ...
        // MISC
        if (fullName.equals("certusTank")) return new ResolverResult(BlockEnum.CERTUSTANK.getInternalName(), 0);
        if (fullName.equals("fluidPattern")) return new ResolverResult(ItemEnum.FLUIDPATTERN.getInternalName(), 0);
        if (fullName.equals("fluidCrafter")) return new ResolverResult(BlockEnum.FLUIDCRAFTER.getInternalName(), 0);
        ...
        if (fullName.equals("walrus")) return new ResolverResult(BlockEnum.WALRUS.getInternalName(), 0);
        if (fullName.equals("interface")) return new ResolverResult(BlockEnum.ECBASEBLOCK.getInternalName(), 0);
        if (fullName.equals("fluidFiller")) return new ResolverResult(BlockEnum.ECBASEBLOCK.getInternalName(), 1);
