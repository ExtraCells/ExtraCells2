...
public class GuiUtil {
    ...
    public static boolean isPointInRegion(float guiLeft, int guiTop, int top, int left, int height, int width,
    ...
    public static boolean renderOverlay(float zLevel, int guiLeft, int guiTop, WidgetFluidSlot fluidSlot, int mouseX,
            int mouseY) {
