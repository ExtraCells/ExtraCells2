    ...
    public void registerTexture(TextureMap textureMap) {
        ...
        for (int i = 0; i < this.textureNames.length; i++) {
            if (this.textureType == TextureType.PART)
                this.textures[i] = textureMap.registerIcon("extracells:part/" + this.textureNames[i]);
            if (this.textureType == TextureType.BLOCK || this.textureType == TextureType.ITEM)
                this.textures[i] = textureMap.registerIcon("extracells:" + this.textureNames[i]);
        }
    }
}
