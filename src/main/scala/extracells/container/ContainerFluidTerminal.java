...
public class ContainerFluidTerminal extends Container
    ...
    public void forceFluidUpdate(String searchText) {
        if (this.monitor != null) {
            ...
            new PacketFluidTerminal(this.player, fluidStackList).sendPacketToPlayer(this.player);
        }
    }
    ...
    public void receiveSelectedFluid(Fluid _selectedFluid) {
        ...
        if (this.guiFluidTerminal != null) this.guiFluidTerminal.updateSelectedFluid();
    }

    public void setGui(GuiFluidTerminal _guiFluidTerminal) {
        if (_guiFluidTerminal != null) this.guiFluidTerminal = _guiFluidTerminal;
    }
    ...
    public void updateFluidList(IItemList<IAEFluidStack> _fluidStackList) {
        ...
        if (this.guiFluidTerminal != null) this.guiFluidTerminal.updateFluids();
    }
