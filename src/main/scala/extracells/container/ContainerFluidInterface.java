    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slotnumber) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotnumber < this.inventorySlots.size() - 9) {
                if (!mergeItemStack(itemstack1, this.inventorySlots.size() - 9, this.inventorySlots.size(), true)) {
                    return null;
                }
            } else if (!mergeItemStack(itemstack1, 9, this.inventorySlots.size() - 9, false)) {
                return null;
            }
