...
public class ItemStorageComponent extends ItemECBase implements IStorageComponent {
    ...
    public final String[] suffixes = { "physical.256k", "physical.1024k", "physical.4096k", "physical.16384k",
            "fluid.1k", "fluid.4k", "fluid.16k", "fluid.64k", "fluid.256k", "fluid.1024k", "fluid.4096k", "gas.1k",
            "gas.4k", "gas.16k", "gas.64k", "gas.256k", "gas.1024k", "gas.4096k" };
    public final int[] size = new int[] { 262144, 1048576, 4194304, 16777216, 1024, 4096, 16384, 65536, 262144, 1048576,
            4194304 };
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < this.suffixes.length; ++i) {
            this.icons[i] = iconRegister
                    .registerIcon(String.format("extracells:storage.component.%s", this.suffixes[i]));
        }
    }
}
