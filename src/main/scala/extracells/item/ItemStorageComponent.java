...
public class ItemStorageComponent extends ItemECBase implements IStorageComponent {
    ...
    public final int[] size =
            new int[] {262144, 1048576, 4194304, 16777216, 1024, 4096, 16384, 65536, 262144, 1048576, 4194304};
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < this.suffixes.length; ++i) {
            this.icons[i] =
                    iconRegister.registerIcon(String.format("extracells:storage.component.%s", this.suffixes[i]));
        }
    }
}
