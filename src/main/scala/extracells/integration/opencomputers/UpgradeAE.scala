...
class UpgradeAE(envHost: EnvironmentHost) extends li.cil.oc.api.prefab.ManagedEnvironment with NetworkControl[TileEntity with IActionHost with IGridHost]{
