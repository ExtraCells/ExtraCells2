...
object OCUtils {
  ...
  def getComponent(robot: RobotData, item: Item): ItemStack =
    getComponent(robot, item, 0)
  ...
  def getComponent(drone: DroneData, item: Item): ItemStack =
    getComponent(drone, item, 0)
