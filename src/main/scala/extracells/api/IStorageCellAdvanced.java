 ...
 * <p>
 * This implementation is a mirror of the standard AE2 item cell type, but allows for any amount of types (within
 * reason) and larger byte amounts.
 */
public interface IStorageCellAdvanced extends ICellWorkbenchItem {

    /**
     * It wont work if the return is not a multiple of 8. The limit is ({@link Long#MAX_VALUE}) / 8.
     *
     * @param cellItem item
