...
public class ChannelHandler {
    ...
    public static void registerMessages() {
        wrapper.registerMessage(HandlerFluidSlot.class, PacketFluidSlot.class, 0, Side.CLIENT);
        wrapper.registerMessage(HandlerFluidSlot.class, PacketFluidSlot.class, 0, Side.SERVER);

        wrapper.registerMessage(HandlerBusFluidIO.class, PacketBusFluidIO.class, 1, Side.CLIENT);
        wrapper.registerMessage(HandlerBusFluidIO.class, PacketBusFluidIO.class, 1, Side.SERVER);

        wrapper.registerMessage(HandlerBusFluidStorage.class, PacketBusFluidStorage.class, 2, Side.CLIENT);
        wrapper.registerMessage(HandlerBusFluidStorage.class, PacketBusFluidStorage.class, 2, Side.SERVER);

        wrapper.registerMessage(HandlerFluidEmitter.class, PacketFluidEmitter.class, 3, Side.CLIENT);
        wrapper.registerMessage(HandlerFluidEmitter.class, PacketFluidEmitter.class, 3, Side.SERVER);

        wrapper.registerMessage(HandlerFluidPlaneFormation.class, PacketFluidPlaneFormation.class, 4, Side.CLIENT);
        wrapper.registerMessage(HandlerFluidPlaneFormation.class, PacketFluidPlaneFormation.class, 4, Side.SERVER);

        wrapper.registerMessage(HandlerFluidStorage.class, PacketFluidStorage.class, 5, Side.CLIENT);
        wrapper.registerMessage(HandlerFluidStorage.class, PacketFluidStorage.class, 5, Side.SERVER);
        ...
        wrapper.registerMessage(HandlerGuiSwitch.class, PacketGuiSwitch.class, 10, Side.CLIENT);
        wrapper.registerMessage(HandlerGuiSwitch.class, PacketGuiSwitch.class, 10, Side.SERVER);
    }
