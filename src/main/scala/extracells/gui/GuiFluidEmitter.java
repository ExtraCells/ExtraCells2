...
public class GuiFluidEmitter extends ECGuiContainer implements IFluidSlotGui, INEIGuiHandler {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        ((WidgetRedstoneModes) this.buttonList.get(6))
                .drawTooltip(mouseX, mouseY, (this.width - xSize) / 2, (this.height - ySize) / 2);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseBtn) {
        ...
        if (GuiUtil.isPointInRegion(
                this.guiLeft,
                this.guiTop,
                this.fluidSlot.getPosX(),
                this.fluidSlot.getPosY(),
                18,
                18,
                mouseX,
                mouseY)) {
            ...
            else this.fluidSlot.mouseClicked(this.player.inventory.getItemStack());
        }
    }
