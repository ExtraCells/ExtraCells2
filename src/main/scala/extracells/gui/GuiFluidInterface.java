    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRendererObj.drawString(
                Item.getItemFromBlock(BlockEnum.ECBASEBLOCK.getBlock())
                        .getItemStackDisplayName(new ItemStack(BlockEnum.ECBASEBLOCK.getBlock(), 1, 0))
                        .replace("ME ", ""),
                8,
                5,
                0x000000);
        ...
        for (WidgetFluidTank tank : this.tanks) {
            if (tank != null) tank.draw(this.guiLeft, this.guiTop, mouseX, mouseY);
        }
    ...
    public void initGui() {
        ...
        for (int i = 0; i < this.tanks.length; i++) {
            ...
            this.tanks[i] = new WidgetFluidTank(
                    this.fluidInterface.getFluidTank(ForgeDirection.getOrientation(i)),
                    i * 20 + 30,
                    16,
