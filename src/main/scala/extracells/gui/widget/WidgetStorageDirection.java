    ...
    public void drawButton(Minecraft minecraftInstance, int x, int y) {
        ...
        switch (this.access) {
            case NO_ACCESS:
                ...
                break;
            case READ:
                drawTexturedModalRect(this.xPosition, this.yPosition, 16, 144, 16, 16);
                break;
            case READ_WRITE:
                drawTexturedModalRect(this.xPosition, this.yPosition, 32, 144, 16, 16);
                break;
            case WRITE:
                drawTexturedModalRect(this.xPosition, this.yPosition, 0, 144, 16, 16);
                break;
            default:
                break;
        }
