...
public class GuiBusFluidStorage extends ECGuiContainer
    ...
    protected void drawGuiContainerBackgroundLayer(float alpha, int mouseX, int mouseY) {
        ...
        fontRendererObj.drawString(
                StatCollector.translateToLocal("extracells.gui.fluid.storage"),
                8 + this.guiLeft,
                6 + this.guiTop,
                4210752);
    ...
    public void updateAccessRestriction(AccessRestriction mode) {
        if (this.buttonList.size() > 0) ((WidgetStorageDirection) this.buttonList.get(0)).setAccessRestriction(mode);
    }
