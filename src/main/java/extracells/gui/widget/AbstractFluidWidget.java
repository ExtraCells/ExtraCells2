...
public abstract class AbstractFluidWidget extends Gui
{
	...
	protected GuiTerminalFluid guiTerminalFluid;

	public AbstractFluidWidget(GuiTerminalFluid guiTerminalFluid, int sizeX, int sizeY, Fluid fluid)
	{
		this.guiTerminalFluid = guiTerminalFluid;
		this.sizeX = sizeX;
		this.sizeY = sizeY;
		this.fluid = fluid;
	}
	...
	{
		int k1 = guiTerminalFluid.guiLeft();
		int l1 = guiTerminalFluid.guiTop();
		pointX -= k1;
		pointY -= l1;
