...
public class WidgetStorageDirection extends GuiButton {
    ...
    public WidgetStorageDirection(int ID, int xPos, int yPos, int width, int height, AccessRestriction mode) {
    ...
    public void drawButton(Minecraft minecraftInstance, int x, int y) {
        ...
        switch (access) {
            case NO_ACCESS:
                drawTexturedModalRect(xPosition, yPosition, 96, 0, 16, 16);
                break;
            case READ:
                drawTexturedModalRect(xPosition, yPosition, 16, 144, 16, 16);
                break;
            case READ_WRITE:
                drawTexturedModalRect(xPosition, yPosition, 32, 144, 16, 16);
                break;
            case WRITE:
                drawTexturedModalRect(xPosition, yPosition, 0, 144, 16, 16);
                break;
            default:
                break;
        }
    ...
    public void drawTooltip(int mouseX, int mouseY, int guiXPos, int guiYPos) {
        ...
        description.add(StatCollector.translateToLocal("gui.tooltips.appliedenergistics2.IOMode"));
        String explanation = "";
        switch (access) {
            case NO_ACCESS:
                explanation = StatCollector.translateToLocal("gui.tooltips.appliedenergistics2.Disabled");
                break;
            case READ:
                explanation = StatCollector.translateToLocal("gui.tooltips.appliedenergistics2.Read");
                break;
            case READ_WRITE:
                explanation = StatCollector.translateToLocal("gui.tooltips.appliedenergistics2.ReadWrite");
                break;
            case WRITE:
                explanation = StatCollector.translateToLocal("gui.tooltips.appliedenergistics2.Write");
                break;
            default:
                break;
        }
