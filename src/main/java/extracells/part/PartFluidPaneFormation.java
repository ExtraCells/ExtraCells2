...
public class PartFluidPaneFormation extends PartECBase implements PacketFluidSlot.IFluidSlotPart
{
	...
	{
		return new ContainerPaneFormation(this, player);
	}

	public Object getClientGuiElement(EntityPlayer player)
	{
		return new GuiFluidPaneFormation(this, player);
	}
