...
public class CommonProxy implements IGuiHandler
{
	...
	{
		// Items
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cell, 1, 0), ItemCell.localized_names[0]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cell, 1, 1), ItemCell.localized_names[1]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cell, 1, 2), ItemCell.localized_names[2]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cell, 1, 3), ItemCell.localized_names[3]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cell, 1, 4), ItemCell.localized_names[4]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cluster, 1, 0), ItemCluster.localized_names[0]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cluster, 1, 1), ItemCluster.localized_names[1]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cluster, 1, 2), ItemCluster.localized_names[2]);
		LanguageRegistry.instance().addName(new ItemStack(extracells.Cluster, 1, 3), ItemCluster.localized_names[3]);
		LanguageRegistry.instance().addStringLocalization("itemGroup.Extra_Cells", "en_US", "Extra Cells");

		// Blocks
		LanguageRegistry.instance().addName(extracells.SolderingStation, "Soldering-Station");
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		...
		if (tileEntity != null)
		{
			...
			case 0: // GUI Soldering Station
				return new GUISolderingStation();
			default:
				return false;
			}
		} else
